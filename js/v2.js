...
(function () {
    ...
    projectData['f1-undercut'] = {
        ...
        content:
            ...
            step('06', 'What I learned',
                `<p>Strategy under uncertainty reduces to one comparison: does the expected gain from acting now exceed the cost of waiting for better information? The undercut is a clean, measurable instance of it — and the same structure shows up in every allocation decision I've modeled since.</p>`) +
            step('07', 'Stack',
